export const en = {
	...
	'help.nowTrend':
		'Current rate: bytes per second over the last completed one-second window. Where there is room beside the values, a line traces the last minute of samples while the page is open; it starts over after a reset or a pause.',
	...
	'help.kpi.rate':
		'Bytes per second across all rules over the last completed second: \u2191 upload from clients towards targets, \u2193 download back. Where there is room beside the values, a line traces the last minute of samples while the page is open; it starts over after a reset or a pause.',
	'help.kpi.total':
	...
	ruleNameSlash: 'Names must not contain "/".',
	ruleNameTaken: 'A rule with this name already exists.',
	listenAddressTaken: 'Already used by rule "{name}".',
	listenAddressWebUI: 'Already used by the web UI.',
	usernameColon: 'Usernames must not contain ":".',
	passwordNeedsUsername: 'Set a username for this password.',
	hopUrlEmpty: 'Enter a proxy URL.',
	hopUrlNoScheme: 'Include the scheme (e.g. socks5://host:1080).',
